...
class Cortical_Neuron(object):
    def __init__(self, **parameters):
        ...
        self.soma = Section(
            ...
            mechanisms=(
                Mechanism("cortical_soma_i_leak"),
        ...
        for i in np.arange(parameters["num_axon_compartments"]):
            if i == 0:
                self.myelin.append(
                    Section(
                        ...
                        mechanisms=(
                            Mechanism("cortical_axon_i_leak", g_l=0),
            ...
            self.node.append(
                Section(
                    ...
                    mechanisms=(
                        Mechanism("cortical_axon_i_leak", g_l=0.02),
        ...
        self.collateral = Section(
            ...
            mechanisms=(
                Mechanism("cortical_axon_i_leak"),
...
class Cortical_Neuron_Type(NativeCellType):
    ...
    units = {
        "soma(0.5).v": "mV",
        "collateral(0.5).v": "mV",
        "collateral(0.5).i_membrane_": "nA",
        "ais(0.5).v": "mV",
        "middle_node(0.5).v": "mV",
...
class Interneuron(object):
    def __init__(self, **parameters):
        ...
        self.rec = h.NetCon(
            self.source, None, sec=self.source_section
        )  # Needed to clear the simulator
        self.spike_times = h.Vector(0)
...
class STN_Neuron(object):
    def __init__(self, **parameters):
        ...
        self.source = self.soma(0.5)._ref_v
        self.rec = h.NetCon(
            self.source, None, sec=self.soma
        )  # Needed to clear the simulator
        self.spike_times = h.Vector(0)
